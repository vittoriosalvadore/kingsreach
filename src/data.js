...
export const BIOMES = [
  { name:'Haunted Wood',
    ...
    accent:0x6cf09a, prop:'forest', wx:{col:0x6cf09a,mode:'drift',speed:0.5,sway:1.0,dens:0.8,size:0.12}, rumor:'The mist eats sound out there. Step soft.' },
  { name:'Ruined Keep',
    ...
    accent:0xffa64d, prop:'castle', wx:{col:0xd9b24a,mode:'rise',speed:0.5,sway:0.8,dens:0.7,size:0.12}, rumor:'The dead kings still hold their hall. Mind the big one with the slab-blade.' },
  { name:'Emberdeep',
    ...
    accent:0xff5a2a, prop:'dungeon', wx:{col:0xff7a2a,mode:'rise',speed:1.25,sway:1.4,dens:1.4,size:0.17}, rumor:'Down where it burns, some things wear stone for skin. Steel wont bite. Break their guard.' },
  { name:'Frostfen',
  ...
  { name:'Astral Verge',
    ...
    accent:0xc070ff, prop:'dungeon', wx:{col:0xc9a8ff,mode:'rise',speed:0.7,sway:0.6,dens:1.0,size:0.14}, rumor:'The sky is wrong here. Stars fall upward. Do not follow them.' },
  { name:'Bloodmoon Grove',
    ...
    accent:0xff4d5e, prop:'forest', wx:{col:0xff2e44,mode:'fall',speed:0.5,sway:0.15,dens:0.9,size:0.18}, rumor:'Under the red moon the trees drink deep. Spill no blood you can spare.' },
  { name:'Gilded Sanctum',
    ...
    accent:0xffcf5a, prop:'castle', wx:{col:0xffcf5a,mode:'drift',speed:0.45,sway:0.7,dens:1.1,size:0.13}, rumor:'Gold buried the faithful here, and greed dug them back up.' },
];
